...
for j in range(5):
    ...
    db1 = pd.DataFrame({'Video' : '  ', '2A-prob-1' : '  ', '2A-prob-2' : '  ', '3A-prob-1' : '  ', '3A-prob-2' : '  ', '4A-prob-1' : '  ', '4A-prob-2' : '  ', 'MEAN-prob-1' : '  ', 'MEAN-prob-2' : '  ', 'Prediction' : '  ', 'Accuracy' : '  ', 'Accuracy_2A' : '  ', 'Accuracy_3A' : '  ', 'Accuracy_4A' : '  '},  index = [-1])    
    with open ('framework-analysisMEAN.csv', 'a') as f:
        db1.to_csv(f, header = False)